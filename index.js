...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    ...
    counter1 is the function expression and counter2 is a function declaration.

  2. Which of the two uses a closure? How can you tell? 

    counter 1 uses closure as the counter function has an access to counterMaker function

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  

     For long or complex functions counter1 code is preferable for better organization, in all simple functions we can use counter2
*/
